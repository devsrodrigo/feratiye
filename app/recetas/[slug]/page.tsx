...
export default async function RecipeDetailPage({
  ...
  const isYoutubeVideo =
    recipe.tiktokUrl.includes('youtube.com') || recipe.tiktokUrl.includes('youtu.be');
        ...
        <div className="max-w-3xl mx-auto">
            ...
            >
              {isYoutubeVideo ? (
                <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.5 6.2c-.2-1.4-1.4-2.4-2.8-2.5C17.9 3.5 12 3.5 12 3.5s-5.9 0-8.7.2c-1.4.1-2.6 1.1-2.8 2.5C.2 8.1 0 10 0 10s0 1.9.5 3.8c.2 1.4 1.4 2.4 2.8 2.5 2.8.2 8.7.2 8.7.2s5.9 0 8.7-.2c1.4-.1 2.6-1.1 2.8-2.5.5-1.9.5-3.8.5-3.8s0-1.9-.5-3.8z" />
                  <path d="M9.5 15.5l6-3.5-6-3.5v7z" fill="currentColor" />
                </svg>
              ) : (
              ...
              <span>{isYoutubeVideo ? 'Ver preparación en YouTube' : 'Ver preparación en TikTok'}</span>
            </a>
          </div>
          ...
          <div className="mt-16 p-8 bg-cream rounded-lg text-center">
            ...
            >
              ...
              <span>{isYoutubeVideo ? 'Ver en YouTube →' : 'Ver en TikTok →'}</span>
            </a>
          </div>
        </div>
      </section>
